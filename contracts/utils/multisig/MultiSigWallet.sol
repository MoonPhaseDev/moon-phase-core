...
// from https://github.com/gnosis/MultiSigWallet/blob/master/contracts/MultiSigWallet.sol
// under LGPL3
...
contract MultiSigWallet {
    ...
    function external_call(address destination, uint value, uint dataLength, bytes memory data) internal returns (bool) {
        ...
        return result;
        */
        // the above assembly produces errors when interacting with hierarchical
        // wallets and web3 encoding. Try a simpler version (may be less efficient).
